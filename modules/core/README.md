[![NPM version](https://img.shields.io/npm/v/@cookiehub/core.svg?style=flat-square)](https://www.npmjs.com/package/@cookiehub/core)
[![npm module downloads per month](http://img.shields.io/npm/dm/@cookiehub/core.svg?style=flat)](https://www.npmjs.org/package/@cookiehub/core)
...
npm
```
npm install @cookiehub/core --save
```

yarn
```
yarn add @cookiehub/core
```
...
```javascript
import {TCModel, TCString, GVL} from '@cookiehub/core';
...
import {TCModel, PurposeRestriction, RestrictionType} from '@cookiehub/core';
...
```typescript
import {TCString, TCModel, GVL} from '@cookiehub/core';
...
import {TCString, Segment} from '@cookiehub/core';
