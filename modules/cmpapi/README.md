[![NPM version](https://img.shields.io/npm/v/@cookiehub/cmpapi.svg?style=flat-square)](https://www.npmjs.com/package/@cookiehub/cmpapi)
[![npm module downloads per month](http://img.shields.io/npm/dm/@cookiehub/cmpapi.svg?style=flat)](https://www.npmjs.org/package/@cookiehub/cmpapi)
...
npm
```
npm install @cookiehub/cmpapi --save
```

yarn
```
yarn add @cookiehub/cmpapi
```
...
````javascript
import {CmpApi} from '@cookiehub/cmpapi';
